...
%global package_name origin-monitor-sample-app
%global product_name OpenShift Self Monitoring Sample Application
%global import_path github.com/openshift/monitor-sample-app

Name:           %{package_name}
Version:        %{version}
Release:        %{release}%{?dist}
Summary:        Provides standard metrics and alerting around a self monitoring sample application.
License:        ASL 2.0
...
%description
Provides standard metrics and alerting around a self monitoring sample application.
