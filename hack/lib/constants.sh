...
readonly OS_GO_PACKAGE=github.com/openshift/monitor-sample-app
...
readonly OS_ALL_IMAGES=(
  openshift/origin-monitor-sample-app
)

# os::build::images builds all images in this repo.
function os::build::images() {
  tag_prefix="${OS_IMAGE_PREFIX:-"openshift/origin"}"
  os::build::image "${tag_prefix}-monitor-sample-app" images/origin-monitor-sample-app
}
